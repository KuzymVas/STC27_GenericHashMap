...
public class AVLTreeHashMapTest {
    ...
    public void testToString() {
        try {
            HashMap hm = new AVLTreeHashMap(3);
            hm.put("key1", "val1");
            hm.put("key2", "val2");
            hm.put("key3", "val3");
            hm.put("key4", "val4");
    ...
    public void testEqualsEmpty() {
        HashMap otherHashMap = new AVLTreeHashMap();
