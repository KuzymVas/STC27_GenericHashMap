...
public class AVLTreeNodeTest {
    ...
    public void testToStringTest() {
        final AVLTreeNode<Integer, Object> node = new AVLTreeNode<>(keys.get(0), values.get(0));
        System.out.println("Single node = " + node);
        AVLTreeNode<Integer, Object> root = new AVLTreeNode<>(keys.get(0), values.get(0));
    ...
    public void testCreateSingle() {
        final AVLTreeNode<Integer, Object> root = new AVLTreeNode<>(keys.get(0), values.get(0));
        ...
        final KeyValuePair<Integer, Object> pair = new KeyValuePair<>(keys.get(0), values.get(0));
    ...
    public void testCreateMultiple() {
        ...
        for (Integer i : shuffle) {
            ...
            final KeyValuePair<Integer, Object> pair = new KeyValuePair<>(keys.get(i), values.get(i));
    ...
    public void testEqualsSingle() {
        final AVLTreeNode<Integer, Object> root = new AVLTreeNode<>(keys.get(0), values.get(0));
        final AVLTreeNode<Integer, Object> otherRoot = new AVLTreeNode<>(keys.get(0), values.get(0));
    ...
    public void testEqualsMultiple() {
        AVLTreeNode<Integer, Object> root = new AVLTreeNode<>(keys.get(0), values.get(0));
        AVLTreeNode<Integer, Object> otherRoot = new AVLTreeNode<>(keys.get(0), values.get(0));
    ...
    public void testTreeSelfBalancing() {
        ...
        Integer[] seqKeys = new Integer[1000];
        ...
        AVLTreeNode<Integer, Object> rootReverse = new AVLTreeNode<>(keys.get(0), values.get(0));
        for (int i = 0; i < 1000; i++) {
